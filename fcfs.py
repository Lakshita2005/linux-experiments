#!/usr/bin/env python3
# fcfs.py - First Come First Serve scheduling (non-preemptive)
# Input: interactive prompts: number of processes, then for each: name arrival_time burst_time
...
def fcfs(procs):
    # sort by arrival, stable for equal arrivals
...
def print_table(procs):
    print("\n{:<8} {:<8} {:<8} {:<8} {:<10} {:<8}".format("Process","Arrival","Burst","Start","Completion","Waiting"))
    for p in procs:
